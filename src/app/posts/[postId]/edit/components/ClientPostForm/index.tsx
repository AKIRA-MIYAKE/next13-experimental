...
import { PostForm, PostFormProps } from "../../../../../../components/posts/PostForm"
...
export const ClientPostForm: FC<ClientPostFormProps> = ({ post }) => {
  ...
  const onPostFormSubmit = useCallback<PostFormProps['onSubmit']>(async ({ title, body}) => {
    if (!token) return
  ...
  return <PostForm defaultValue={post} onSubmit={onPostFormSubmit} onRequireDeleting={onPostFormRequireDeleting} />
}
